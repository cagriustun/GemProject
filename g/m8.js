  ...
  require(["DS/WAFData/WAFData", "DS/DataDragAndDrop/DataDragAndDrop"], function (WAFData, DataDragAndDrop) {
    var myWidget = {
      ...
      wafDataGetFunction: function (id) {
        ...
        WAFData.authenticatedRequest(url, {
          ...
          onComplete: function (res) {
            ...
            (customData.operasyon1 == "TALASLI" || customData.operasyon1 == "ON ISLEME") ? operasyonData.push({ "value": "operasyon1 - " + customData.operasyon1, "text": "operasyon 1 - " + customData.operasyon1 }) : "";
            (customData.operasyon2 == "TALASLI" || customData.operasyon2 == "ON ISLEME") ? operasyonData.push({ "value": "operasyon2 - " + customData.operasyon2, "text": "operasyon 2 - " + customData.operasyon2 }) : "";
            (customData.operasyon3 == "TALASLI" || customData.operasyon3 == "ON ISLEME") ? operasyonData.push({ "value": "operasyon3 - " + customData.operasyon3, "text": "operasyon 3 - " + customData.operasyon3 }) : "";
            (customData.operasyon4 == "TALASLI" || customData.operasyon4 == "ON ISLEME") ? operasyonData.push({ "value": "operasyon4 - " + customData.operasyon4, "text": "operasyon 4 - " + customData.operasyon4 }) : "";
            $('#idTezgahSuresi').val('');
            ...
            (customData.tezgah4 != "") ? cuArray.push({ operasyon: customData.operasyon4, tezgah: customData.tezgah4, tezgahSuresi: customData.tezgah_suresi4, operasyonKey: "4" }) : "";
      ...
      wafDataPatchFunction: function (objectID, cestamp, operasyon, tezgah, tezgahSuresi) {
        ...
        var tezgahSuresiWithIndex = "tezgah_suresi" + opIndex;
