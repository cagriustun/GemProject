    ...
    var myWidget = {
      ...
      operasyonSil: function () {
        ...
        if (checkControl != 1) {
          ...
          if (checkIndex == 0) {
            if (cuArray[checkIndex + 1].tezgahSuresi != '' || cuArray[checkIndex + 2].tezgahSuresi != '') {
              myWidget.set_status("SİLMEK İÇİN SON SIRADAKİ VERİYİ SEÇİNİZ");
              return;
            } else {
            ...
            if (cuArray[checkIndex + 1].tezgahSuresi != '') {
              myWidget.set_status("SİLMEK İÇİN SON SIRADAKİ VERİYİ SEÇİNİZ");
              return;
            } else {
              cuArray[checkIndex].tezgah = "";
      ...
      tableAddedFunction: function (data) {
        ...
        tableArray.forEach((item, index) => {
          if (item.tezgah != "") {
            ...
            $('<td>').text(index + 1).appendTo(newRow);
