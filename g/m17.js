  ...
  require(["DS/WAFData/WAFData", "DS/DataDragAndDrop/DataDragAndDrop"], function (WAFData, DataDragAndDrop) {
    var myWidget = {
      ...
      wafDataGetFunction: function (id) {
        ...
        WAFData.authenticatedRequest(url, {
          ...
          onComplete: function (res) {
            ...
            (customData.tezgah1 != "") ? cuArray.push({ operasyon: "TALASLI", tezgah: customData.tezgah1, tezgahSuresi: customData.tezgah_suresi1, operasyonKey: "1" }) : "";
            (customData.tezgah2 != "") ? cuArray.push({ operasyon: "TALASLI", tezgah: customData.tezgah2, tezgahSuresi: customData.tezgah_suresi2, operasyonKey: "2" }) : "";
            (customData.tezgah3 != "") ? cuArray.push({ operasyon: "TALASLI", tezgah: customData.tezgah3, tezgahSuresi: customData.tezgah_suresi3, operasyonKey: "3" }) : "";
      ...
      wafDataPatchFunction: function (objectID, cestamp, operasyon, tezgah, tezgahSuresi) {
        ...
        if (((cuArray.length + 1) > 3) && tezgah != "") {
          myWidget.set_status("MAKSİMUM SAYIDA TEZGAH BİLGİSİ GİRİLMİŞ, KONTROL EDİN");
          return false;
        }
        var tezgahWithIndex = "tezgah" + (tezgah == "" ? ((cuArray.length - 1) + "") : ((cuArray.length) + ""));
        var tezgahSuresiWithIndex = "tezgah_suresi" + (tezgah == "" ? ((cuArray.length - 1) + "") : ((cuArray.length) + ""));
